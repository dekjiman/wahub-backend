export const swaggerSpec = {
  ...
  info: {
    ...
    version: '1.0.0',
    description:
      'Full REST API specification for Limestone Hub — Admin Dashboard managing WhatsApp Community, Groups, Members, AI Automation, Moderation, Broadcasts, and System Integrations.',
    contact: {
